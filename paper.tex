...
\hline
\multirow{2}{*}{\textbf{Ref}} & \multicolumn{6}{c|}{\textbf{Discussed Aspects}} & \multicolumn{3}{c|}{\textbf{Implementation Aspects}} \\ \cline{2-10} 
 & \textbf{\begin{tabular}[c]{@{}c@{}}Security and\\ Privacy\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Identity\\ Management\end{tabular}} & \textbf{M2M} & \textbf{\begin{tabular}[c]{@{}c@{}}Machines\\ Traceability\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Machine\\ Capabilities\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Products\\ Traceability\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Smart Contracts\end{tabular}} & \textbf{Prototype} & \textbf{Platform} \\ \hline
\textbf{\cite{Angrish2018a}} & \cmark & \xmark & \xmark & \cmark & \cmark & \xmark & \begin{tabular}[c]{@{}c@{}}Communication/Trading\end{tabular} & \cmark & Ethereum \\ \hline
\textbf{\cite{Li2018}} & \cmark & \xmark & \xmark & \xmark & \cmark & \xmark & Trading & \cmark & MultiChain \\ \hline
\textbf{\cite{Barenji2019}} & \cmark & \xmark & \cmark & \xmark & \xmark & \xmark & \begin{tabular}[c]{@{}c@{}}Communication/Trading\end{tabular} & \cmark & Hyperledger \\ \hline
\textbf{\cite{Bai2019}} & \cmark & \xmark & \cmark & \xmark & \xmark & \xmark & \begin{tabular}[c]{@{}c@{}}Communication/Trading\end{tabular} & \xmark & \xmark \\ \hline
